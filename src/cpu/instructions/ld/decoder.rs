...
mod tests {
    ...
    fn test_decode_ld8_b_c() {
        ...
        FakeCpu::new().test_decode_ld8(opcode, &Ld8Decoder, 4,
    ...
    fn test_decode_ld8_a_mem_hl() {
        ...
        let opcode = 0x7E;
        FakeCpu::new().test_decode_ld8(opcode, &Ld8Decoder, 8,
    ...
    fn test_decode_ld8_mem_hl_imm8() {
        let opcode = 0x36;
        FakeCpu::new().test_decode_ld8(opcode, &Ld8Decoder, 12,
            Operand::Memory(Memory::HL),
            Operand::Imm8);
    }
    ...
    fn test_decode_ld8_all_reg_to_reg() {
        let regs = [
            ...
            Register8::H, Register8::L, Register8::A,
        ];
