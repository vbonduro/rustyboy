...
mod tests {
    ...
    fn test_execute_rlca() {
        let opcode = Rotate { op: RotateOp::Rlca, cycles: 4 };
    ...
    #[test]
    fn test_execute_rla() {
        let opcode = Rotate { op: RotateOp::Rla, cycles: 4 };
        let actual_cycles = opcode.execute(&mut FakeCpu::new()).unwrap();
        assert_eq!(actual_cycles, 4);
    }
    ...
    fn test_execute_rrca() {
        let opcode = Rotate { op: RotateOp::Rrca, cycles: 4 };
        let actual_cycles = opcode.execute(&mut FakeCpu::new()).unwrap();
        assert_eq!(actual_cycles, 4);
    }
    ...
    #[test]
    fn test_execute_rra() {
        let opcode = Rotate { op: RotateOp::Rra, cycles: 4 };
        let actual_cycles = opcode.execute(&mut FakeCpu::new()).unwrap();
        assert_eq!(actual_cycles, 4);
    }
}
